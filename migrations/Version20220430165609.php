 ...
 */
final class Version20220430165609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, publication_date DATE NOT NULL, isbn VARCHAR(13) NOT NULL, description TEXT NOT NULL, authors TEXT NOT NULL, meap BOOLEAN DEFAULT false NOT NULL, PRIMARY KEY(id))');
